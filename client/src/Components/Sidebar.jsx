    ...
    <div className="dashboard-container">
      ...
      <aside id="sidebar" className={sidebarOpen ? 'sidebar-responsive' : ''}>
        ...
        <ul className="sidebar-list">
          ...
          <li className="sidebar-list-item">
            <a href=" client/public/Articles/index.html" target="_blank">
        ...
        <li className="sidebar-list-item">
            <a href="client/public/Analyze/index.html" target="_blank">
              <span className="material-icons-outlined"></span> Games
            </a>
          </li>
          <li className="sidebar-list-item">
            <a href="Profile.jsx" target="_blank">
              <span className="material-icons-outlined"></span> Profile
            </a>
          </li>
          <li className="sidebar-list-item">
